...
export function getAllUserServerSettings(serverId: string): UserServerSettings[] {
  return Array.from(
...
export function getAllUserServerChannelSettings(serverId: string, channelId: string): UserServerSettings[] {
  return Array.from(
